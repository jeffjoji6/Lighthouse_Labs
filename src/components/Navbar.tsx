  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between h-20 px-6">
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary text-primary-foreground text-sm font-semibold hover:opacity-90 hover:scale-105 transition-all duration-200"
        >
          Start a Project
        </a>
